...
class Application(Frame):
	...
	def _createPictures_old(self, notebook):
		...
		canvas1 = Canvas(old, width=600, height=800, scrollregion=(0,0,600,900)) #width=1256, height = 1674)
		...
		canvas2 = Canvas(old, width=600, height=800, scrollregion=(0,0,600,900)) #width=1256, height = 1674)
